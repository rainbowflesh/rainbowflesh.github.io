...
![image](/images/blogs/tello_hack/tello_hack.jpg)
...
export async function getDroneInfo() {
  return request<API.Drone_Data>("/devices/views/phydot11_accesspoints/devices.json", {
    method: "POST",
...
![img](/images/blogs/tello_hack/IMG20221226144759.jpg)
