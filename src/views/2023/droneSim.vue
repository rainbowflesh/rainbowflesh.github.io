...
<template>
  ...
  <div class="container">
    <div class="content">
      ...
      <p>
        最近研究无人机集群仿真, 用 Pixhawk 2.4.8 做硬件在环, QGC 地面站与 AirSim
        模拟器.
      </p>
      <h2 id="%E8%A3%85%E7%8E%AF%E5%A2%83">装环境</h2>
      <p>
        我们选择在 Windows 平台搭建环境, 主要图 gv100 显卡的驱动稳定性和 UE4
        的软件稳定性.
      </p>
      <p>
        Follow the
      ...
      <ol>
        ...
        <li>
          编译个
          <a href="https://microsoft.github.io/AirSim/build_windows"
            >AirSim 插件</a
          >; 完事后拖进 ue4 用.
        </li>
        <li>
          下载
          <a
            href="https://docs.qgroundcontrol.com/master/en/getting_started/download_and_install.html"
            >QGC</a
          >
        </li>
        <li>
          装个<a href="https://github.com/Tencent/puerts">普洱 TS</a>, 用 cpp 写
          ue 开发不如写 web 简单.
        </li>
        <li>
          装个<a
            href="https://github.com/Esri/vitruvio/blob/main/doc/installation.md"
            >vitruvio</a
          >
          自动生成城市模型, 迫于百京不让航拍扫模只能用次下下策.
        </li>
        <li>
          装 wsl, 最开始测 SIL 的时候 px4 还只能跑在 wsl1 里, 现在好像能在 wsl2
          里运行了, 不过这里还是继续用 1.
        </li>
        <li>在 wsl 里装 px4,</li>
      </ol>
      ...
      <p>
        迫于贫穷, 只能用停产的 pixhawk 2.4.8 平台, 出于一些奇妙深刻的原因,
        还不能用 px4 飞控, 被迫下载
      ...
      <hr />
      <p>
        下载固件其实是很简单的, 只需要将飞控硬件用 usb 连接到电脑, 打开 QGC
        菜单选择载具配置, 里面有可视化界面和自动脚本去完成下载.
      </p>
      <p>
        但是 fmt 有一些 bug, 不知道是飞控硬件摔了, 还是太过古老的设备不支持, gps
        模块, 高度计都是出错的, 似乎只有水平仪<strong>能够</strong>工作
        (放在水平面上是歪的).
      </p>
