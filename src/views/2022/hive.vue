...
<template>
  ...
  <div class="container">
    <div class="content">
              ...
              <ol>
                  ...
                  <ol>
                    ...
                    <li>
                      ...
                      <ol>
                        <li>
                          <a
                            href="#%E4%B8%8A%E4%BC%A0%E5%88%B0%E5%88%86%E5%8C%BA%E7%9B%AE%E5%BD%95-%E4%BB%A4%E5%88%86%E5%8C%BA%E8%A1%A8%E5%92%8C%E6%95%B0%E6%8D%AE%E5%85%B3%E8%81%94"
                            >上传到分区目录, 令分区表和数据关联</a
                          >
                        </li>
                      </ol>
                ...
                <li>
                  <a href="#ordersortdistributecluster-by-%E7%9A%84%E5%8C%BA%E5%88%AB"
                    >order/sort/distribute/cluster by 的区别</a
                  >
                </li>
                <li>
                  ...
                  <ol>
                    <li>
                      <a
                        href="#%E9%92%88%E5%AF%B9%E6%95%B0%E6%8D%AE%E5%86%85%E5%AE%B9%E8%AE%BE%E7%BD%AE%E5%90%88%E7%90%86%E7%9A%84-map-%E6%95%B0%E9%87%8F"
                        >针对数据内容设置合理的 Map 数量</a
                      >
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ol>
                    <li><a href="#hive-sitexml">hive-site.xml</a></li>
                    <li>
      ...
      <h5
        id="%E4%B8%8A%E4%BC%A0%E5%88%B0%E5%88%86%E5%8C%BA%E7%9B%AE%E5%BD%95-%E4%BB%A4%E5%88%86%E5%8C%BA%E8%A1%A8%E5%92%8C%E6%95%B0%E6%8D%AE%E5%85%B3%E8%81%94"
      >
        上传到分区目录, 令分区表和数据关联
      </h5>
      <ul>
      ...
      <pre class="hljs"><code><div>dfs -mkdir -p path
dfs -put path
...
alter table table_name add partition (partition_colN=partition_valueN);
      ...
      <h3 id="ordersortdistributecluster-by-%E7%9A%84%E5%8C%BA%E5%88%AB">order/sort/distribute/cluster by 的区别</h3>
      <ul>
        ...
        <li>
          ...
          <ul>
            ...
            <li>sort by 不受 <code>hive.mapred.mode</code> 是否为 strict, nostrict 的影响.</li>
      ...
      <h4
        id="%E9%92%88%E5%AF%B9%E6%95%B0%E6%8D%AE%E5%86%85%E5%AE%B9%E8%AE%BE%E7%BD%AE%E5%90%88%E7%90%86%E7%9A%84-map-%E6%95%B0%E9%87%8F"
      >
        针对数据内容设置合理的 Map 数量
      </h4>
      ...
      <p>
        不. 如果一个任务有很多小文件 (远远小于块大小 128m), 则每个小文件也会被当做一个块, 用一个 map 任务来完成, 而一个
        map 任务启动和初始化的时间远远大于逻辑处理的时间, 就会造成很大的资源浪费. 而且, 同时可执行的 map 数是受限的.
      </p>
      <blockquote>
        <p>保证每个 map 都是 128 mb?</p>
      </blockquote>
      <p>
        不. 比如有一个 127m 的文件, 正常会用一个 map 去完成, 但这个文件只有一个或者两个小字段, 却有大量记录, 如果 map
        处理的逻辑比较复杂, 用一个 map 任务去做, 肯定也比较耗时.
      </p>
      <h4 id="%E5%B0%8F%E6%96%87%E4%BB%B6%E5%90%88%E5%B9%B6">小文件合并</h4>
      <p>在 Map 前合并小文件. 例如合并小于 iAmSize 的文件:</p>
      <pre class="hljs"><code><div><span class="hljs-keyword">set</span> mapred.max.split.size = iAmSize;
...
<span class="hljs-keyword">set</span> hive.input.format = org.apache.hadoop.hive.ql.io.CombineHiveInputFormat;
      ...
      <p>
        当 Input 的文件都很大, 任务逻辑复杂, Map 执行非常慢的时候, 可以考虑增加 Map 数, 来使得每个 Map 处理的数据量减少,
        从而提高任务的执行效率.
      </p>
      <blockquote>
        <p>
      ...
      <pre class="hljs"><code><div><span class="hljs-comment">-- 默认值为 1 --</span>
...
<span class="hljs-keyword">set</span> mapreduce.input.fileinputformat.split.maxsize = N*<span class="hljs-number">1024</span>*<span class="hljs-number">1024</span>;
      ...
      <h3 id="hive-%E5%88%86%E5%8C%BA%E6%98%AF%E5%90%A6%E8%B6%8A%E5%A4%9A%E8%B6%8A%E5%A5%BD">HIVE 分区是否越多越好</h3>
      <ul>
        <li>
          <p>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">configuration</span>&gt;</span>
      ...
      <pre class="hljs"><code><div>// 合并 Block 减少 Task 数量
...
<span class="hljs-tag">&lt;/<span class="hljs-name">configuration</span>&gt;</span>
      ...
      <ul>
        ...
        <li>
          <a href="https://cwiki.apache.org/confluence/display/hive/languagemanual+orc">Optimized Row Columnar 格式</a>
          <ul>
            <li>
              <p>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  rowData: 真正的数据存储; 存的是具体的数据, 先取部分行, 对其按列进行储存, 并编码各列, 分成多个 Stream
                  来储存,
                </li>
            ...
            <li>
              <p>
                ...
                首先寻址到文件尾部读取 PostScript, 解析出 FileFooter 的长度, 再读取 FileFooter, 并解析读取 Stripe 信息.
              </p>
            </li>
          </ul>
        </li>
        <li>
          <ul>
            ...
            <li>
              通常情况下, 储存 PARQUET 数据都会按照 Block 的大小设置<em>行组</em>的大小, 配合 Mapper 处理任务的最小单位
              (1 Block) 优化任务执行并行量.
            </li>
          </ul>
        </li>
