  ...
  return (
    <div className="standard-dialog p-12">
      ...
      <div>
            ...
            <ol>
              <li>
                ...
                <ol>
                  ...
                  <li>
                    <a href="#%E6%90%AD%E5%BB%BA-hadoop-%E9%9B%86%E7%BE%A4%E7%9A%84%E4%B8%BB%E8%A6%81%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6">
                      搭建 Hadoop 集群的主要配置文件
                    </a>
                  </li>
                  <li>
                    <a href="#%E6%AD%A3%E5%B8%B8%E7%9A%84-hadoop-%E9%9B%86%E7%BE%A4%E8%BF%9B%E7%A8%8B%E4%B8%8E%E4%BD%9C%E7%94%A8">
                      正常的 Hadoop 集群进程与作用
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="#hadoop-%E7%9A%84-rack-awareness-%E6%98%AF%E4%BB%80%E4%B9%88">
              ...
              <li>
                ...
                <ol>
                  <li>
                    <a href="#hdfs-%E6%96%87%E4%BB%B6%E7%9A%84%E4%B8%80%E4%BA%9B%E6%A6%82%E5%BF%B5">
                      HDFS 文件的一些概念
                    </a>
                  </li>
                  <li>
                    ...
                    <ol>
                      <li>
                        <a href="#block-%E5%92%8C%E8%BE%93%E5%85%A5%E5%88%86%E5%89%B2%E7%9B%B4%E6%8E%A5%E6%9C%89%E4%BB%80%E4%B9%88%E5%8C%BA%E5%88%AB">
                          Block 和输入分割直接有什么区别
                        </a>
                      </li>
                      <li>
                  ...
                  <li>
                    <a href="#hdfs-%E5%AF%B9%E5%8D%95%E7%8B%AC%E4%B8%80%E4%B8%AA%E6%96%87%E4%BB%B6%E8%B0%83%E6%95%B4-block-%E5%A4%A7%E5%B0%8F">
                  ...
                  <li>
                    <a href="#hdfs-%E5%86%99%E8%BF%87%E7%A8%8B">HDFS 写过程</a>
                  </li>
                  <li>
                    <a href="#hdfs-%E8%AF%BB%E8%BF%87%E7%A8%8B">HDFS 读过程</a>
                  </li>
                  <li>
                    <a href="#%E5%BE%80-hdfs-%E9%87%8C-put-%E6%96%87%E4%BB%B6%E6%97%B6-hdfs-%E9%83%BD%E5%81%9A%E4%BA%86%E4%BB%80%E4%B9%88">
              ...
              <li>
                ...
                <ol>
                  ...
                  <li>
                    <a href="#map-%E8%BE%93%E5%87%BA%E7%9A%84%E6%95%B0%E6%8D%AE%E8%B6%85%E5%87%BA%E5%B0%8F%E6%96%87%E4%BB%B6%E5%86%85%E5%AD%98%E5%90%8E%E4%BC%9A%E5%8F%91%E7%94%9F%E4%BB%80%E4%B9%88">
                  ...
                  <li>
                    <a href="#split-%E6%9C%BA%E5%88%B6">Split 机制</a>
                  </li>
                  <li>
              ...
              <li>
                ...
                <ol>
                  <li>
                    <a href="#yarn-%E7%9A%84%E4%BC%98%E5%8A%BF">YARN 的优势</a>
                  </li>
                  <li>
        ...
        <p>
          这时 NameNode 滚动当前正在写的 Edits, 将刚刚滚动掉的和之前 Edits 文件进行合并. Secondary NameNode 下载 Edits
          文件, 然后将 Edits 文件和自身保存的 fsimage 文件在内存中进行合并, 然后写入磁盘并上传新的 fsimage 到 nameNode,
          这时 NameNode 将旧的 fsimage 用新的替换掉.
        </p>
        <blockquote>
          <p>
            <code>hdfs haadmin -getServiceState namenode_name</code> 查看状态.
          </p>
        </blockquote>
        ...
        <ol>
          ...
          <li>
            一旦新的 NameNode 完成加载最后一个从 DataNode 接收到足够阻止报告的 CheckPoint FsImage, 它将开始为 Client
            提供服务.
          </li>
        </ol>
        ...
        <ul>
          <li>
            <p>
              元信息: 是数据文件的 Block 大小, 文件副本存储位置, 副本数量, Block 数量, 主要体现在 Edits 文件和 Fsimage
              文件.
            </p>
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              <li>
                由于 Edits 文件记录了最新状态信息, 并且随着操作越多, Edits 文件就会越大, 把 Edits 文件中最新的信息写到
                fsimage 文件中就解决了 Edits 文件数量多不方便管理的情况. 没有体现 HDFS 的最新状态.
              </li>
            </ul>
          </li>
          <li>
        ...
        <h4 id="block-%E5%92%8C%E8%BE%93%E5%85%A5%E5%88%86%E5%89%B2%E7%9B%B4%E6%8E%A5%E6%9C%89%E4%BB%80%E4%B9%88%E5%8C%BA%E5%88%AB">
          Block 和输入分割直接有什么区别
        </h4>
        <p>HDFS 将输入数据物理上划分为 Block; 输入拆分是映射器对数据的逻辑划分, 用于映射操作.</p>
        <h4 id="hdfs-%E7%9A%84-block-%E6%80%8E%E4%B9%88%E8%B0%83%E6%95%B4%E5%A4%A7%E5%B0%8F">
          HDFS 的 Block 怎么调整大小
        </h4>
        ...
        <h3 id="hdfs-%E5%AF%B9%E5%8D%95%E7%8B%AC%E4%B8%80%E4%B8%AA%E6%96%87%E4%BB%B6%E8%B0%83%E6%95%B4-block-%E5%A4%A7%E5%B0%8F">
          HDFS 对单独一个文件调整 Block 大小
        </h3>
        <pre className="hljs">
          <code>
            <div>hdfs dfs -Ddfs.Blocksize=size=mb*1024*1024 -put FILE_DIR HDFS_DIR{"\n"}</div>
          </code>
        </pre>
        ...
        <ol>
          ...
          <li>
            Client 若请求 NameNode 使用就近原则, 则向最近的 DataNode 上传数据, DataNode 与其他节点建立 Pipeline
            并逐级调用.
          </li>
          <li>
            Client 上传第一个 Block 到 DataNode, DataNode 以 Package 为单位向其他节点传输 Package 并创建应答队列与等待.
          </li>
          <li>
            当第一个 Block 传输完成后, Client 再次请求 NameNode 上传第二个 Block. 此时的 Client 传输和 Block
            的汇报是并行的.
          </li>
        </ol>
        ...
        <ol>
          <li>
            <p>
              MapReduce 将得到的 Split 分配对应的 Task, 每个任务处理相对应的 Split, 以 Line 方式读取单行数据,
              数据依次读到
          ...
          <li>
            <p>
              再将分区中数据按照 Key 分组和排序, 默认是字典和升序. 如果设置了 setCombinerClass
              则会对每个分区中的数据进行 Combiner 操作.
          ...
          <li>
            <p>
              NodeManager 将启动一个 <code>mapreduce_Shuffle</code> 服务将数据以 HTTP 的方式 PULL 到一个节点上, 到
              Reduce 上. Reduce 处理达到阈值或 Map 输出达到阈值便 Merge ( 同一分区的一组数据会先进行归并), Sort
              (将归并好的数据进行排序), group (判断迭代器中的元素是否可以迭代), 处理完成后 MapReduce
              将同一分区内的数据写入 HDFS.
            </p>
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            Client 将所需数据上传给 HDFS, 包括 MapReduce 打包的 jar 文件, 配置文件, 以及计算所需的输入划分信息;
            这些文件储存在 JobTracker 的 JobID 目录中, jar 会创建多个副本, 输入划分信息对应着 JobTracker 应启动多少个
            Map 任务.
          </li>
        ...
        <blockquote>
          <p>
            数据倾斜发生在 Reduce 端. Mapper 处理完数据传给 Reduce, 此时 Reduce 会因为大量的 Key
            导致执行时间过长引起堵塞.
          </p>
        </blockquote>
        <p>优化数据倾斜:</p>
        <p>
          对数据进行清洗与治理. 可以在 Mapper 期间将大量相同的 Key 打散, 比如添加 N 以内的随机数前缀; 可以对数据较多的
          Key 进行子扩展, 先进行局部操作, 再去除随机数后 Combiner, 避免在 Shuffle 时出现数据倾斜.
        </p>
        <h3 id="mapper-combiner-%E5%90%8E%E4%BC%9A%E5%8F%91%E7%94%9F%E4%BB%80%E4%B9%88">
          Mapper Combiner 后会发生什么
        </h3>
        <p>运行速度会提升, Mapper 到 Reduce 的数据量也会变少, 因为 Combiner 把相同的 Key 合并了.</p>
        <h3 id="map-%E8%BE%93%E5%87%BA%E7%9A%84%E6%95%B0%E6%8D%AE%E8%B6%85%E5%87%BA%E5%B0%8F%E6%96%87%E4%BB%B6%E5%86%85%E5%AD%98%E5%90%8E%E4%BC%9A%E5%8F%91%E7%94%9F%E4%BB%80%E4%B9%88">
          Map 输出的数据超出小文件内存后会发生什么
        </h3>
        ...
        <p>
          Spilt 是 MapReduce 中 Map 之前的概念. Split 切片大小默认为 Block 的 1.1 倍, 在<code>FileInputFormat</code>{" "}
          中计算切片大小的逻辑:
        </p>
        <pre className="hljs">
          <code>
            <div>
              <span className="hljs-keyword">public</span> <span className="hljs-keyword">static</span>{" "}
              <span className="hljs-keyword">final</span> String SPLIT_MAXSIZE=
              <span className="hljs-string">"mapreduce.input.fileinputformat.split.maxsize"</span>;{"\n"}
              <span className="hljs-keyword">public</span> <span className="hljs-keyword">static</span>{" "}
              <span className="hljs-keyword">final</span> String SPLIT_MINSIZE=
              <span className="hljs-string">"mapreduce.input.fileinputformat.split.minsize"</span>;{"\n"}
              <span className="hljs-function">
                <span className="hljs-keyword">protected</span> <span className="hljs-keyword">long</span>{" "}
                <span className="hljs-title">computeSplitSize</span>
                <span className="hljs-params">
                  (<span className="hljs-keyword">long</span> BlockSize,<span className="hljs-keyword">long</span>{" "}
                  minSize,<span className="hljs-keyword">long</span> maxSize)
                </span>
              </span>
              {"{"}
              {"\n"}
              {"        "}
              <span className="hljs-keyword">return</span> Math.max(minSize,Math.min(maxSize,BlockSize));{"\n"}
              {"        "}
              {"}"}
              {"\n"}
            </div>
        ...
        <ol>
          ...
          <li>
            通过 ApplicationMaster 与 ReSourceManager 进行资源的申请和状态交互, 由 NodeManagers 进行 MapReduce 运行时
            Job 的管理.
          </li>
